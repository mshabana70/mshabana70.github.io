'use client';
import { personalInfo, socialLinks } from '../../assets/assets';
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            {personalInfo.title} at {personalInfo.organization}.
                            Focused on making AI systems more secure and trustworthy.
                        </p>
                    </div>
                        ...
                        <div className="flex gap-3 mb-4">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-900 hover:bg-purple-600 text-gray-400 hover:text-white transition-all border border-gray-800 hover:border-purple-600"
